...
#' @export
#' @title Get Peak Table
#' @description
#' A wrapper of the `mpactr::get_peak_table()` function. Will return
#' the generated peak table.
#' @param mpactr_object The object generated from `import_all_data()`.
#' @examples
#' data <-
...
#'  filtered_data, 10, 6)
#' 
#' get_peaks_table_mpactr(data)
#'
#' @return a `data.frame` object contain all of the ms1 data.
get_peaks_table_mpactr <- function(mpactr_object) {
  if(!inherits(mpactr_object, "filter_pactr")) {
    stop("mpactr object must be generated from the `import_all_data()` function.")
  }
...
#' @title Get Metadata
#' @description
#' #' A wrapper of the `mpactr::get_metadata()` function. Will return
...
#' change_rt_to_seconds_or_minute(filtered_data, "minutes")
#'
#' get_metadata_mpactr(data)
#'
#' @return a `data.frame` object contain all the metadata.
get_metadata_mpactr <- function(mpactr_object) {
  if(!inherits(mpactr_object, "filter_pactr")) {
    stop("mpactr object must be generated from the `import_all_data()` function.")
  }
