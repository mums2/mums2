...
AnnotateMs2Features <- function(variableId, ms2Id, ms2Mz, ms2Rt, formulas, ms2Spectra, reference, parameters, precursorThreshold, minScore, chemicalMinScore, minPeaks) {
