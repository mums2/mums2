...
#' precursor_tolerance, min_score, min_peaks, cluster_data = NULL, formulas = NULL)
#'
#' @export
annotate_ms2 <- function(query, reference, score_params,
                         precursor_tolerance, min_score, min_peaks = 6, 
                         chemical_min_score = 0, cluster_data = NULL, formulas = NULL) {
