...
`create_community_matrix_object()` function. Depending on the size of
your data, the created object may require a substantial amount of
memory.
...
(bray curtis). We also have implemented a function called `rarefy_ms()`
...
diversity index calculation and rarefy the data “n” number of times,
then it will calculate the average of all the runs. This allows users to
ensure all of their data was accounted for when attempting to analyze
diversity.
