...
data <- import_all_data(
  ...
  metadata = mums2::mums2_example("meta_data_boryillus.csv"), 
  format = "Progenesis")
```
...
head(alpha_summary(community_object = community_w_omus, size = 4000, threshold = 10,
...
meta_data <- get_metadata(filtered_data)
