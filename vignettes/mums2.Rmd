...
as_tibble(pcoa$points, rownames = "sample") |>
  inner_join(mpactr::get_metadata(filtered_data), by = c("sample" = "Injection")) |>
...
```{r samples}
  ...
  mpactr::get_metadata(filtered_data)[, c("Injection", "Sample_Code")]
```
...
metadata <- mpactr::get_metadata(filtered_data)
